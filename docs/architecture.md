...
The production relay server lives in [getpaseo/paseo-relay](https://github.com/getpaseo/paseo-relay). It is a distributed Elixir service. The VIBES Cloudflare modernization remains an isolated, disabled-by-default PoC and is not deployed; see [vibes-relay-poc.md](vibes-relay-poc.md).
