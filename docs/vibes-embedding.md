...
VIBES uses the hosted official Relay at `relay.paseo.sh:443`; its trust boundary and completed E2EE/Luna/cellular-phone admission live in [vibes-official-relay.md](vibes-official-relay.md). The Cloudflare Durable Object PoC is not part of the maintained source or Production route. Production Release is still held by the exact Preview pointer retest, merged-main preflight, and separate same-turn authorization; neither Stage nor Relay admission authorizes a deployment.
