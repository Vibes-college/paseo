...
| [docs/vibes-embedding.md](docs/vibes-embedding.md)                   | VIBES authority, accepted milestone line, ownership boundary, and Stage 6/7 gates                                              |
| [docs/vibes-official-relay.md](docs/vibes-official-relay.md)         | VIBES hosted official Relay decision, trust boundary, admission evidence, and remaining Release boundary                       |
